        ...
        public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
        {
            ...
            services.Scan(scan => scan
                .FromAssembliesOf(typeof(IUnitOfWork), typeof(UnitOfWork))
                    ...
                    .AddClasses(classes => classes.InNamespaces("DesafioTecnico.Infrastructure.Data.Repositories"))
                    ...
                    .AddClasses(classes => classes.Where(type => type.Namespace.Equals("DesafioTecnico.Infrastructure.Data.Repositories") &&
