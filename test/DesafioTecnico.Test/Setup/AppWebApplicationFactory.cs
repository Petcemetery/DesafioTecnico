...
using DesafioTecnico.Configuration;
using DesafioTecnico.Security;
using DesafioTecnico.Test.Configuration;
...
namespace DesafioTecnico.Test.Setup
{
        ...
        where TEntryPoint : class
    {
        ...
        {
            builder
                .UseSolutionRelativeContentRoot("src/DesafioTecnico")
